...
#include "Enemy/TestEnemyPlayer.h"
...
// Sets default values
ATestEnemyPlayer::ATestEnemyPlayer()
{
...
void ATestEnemyPlayer::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ATestEnemyPlayer::Tick(float DeltaTime)
{
...
void ATestEnemyPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (pc)
	{
		...
		if (playerInput)
		{
			playerInput->BindAction(ia_Move, ETriggerEvent::Triggered, this, &ATestEnemyPlayer::OnMove);
		}
	}
}

void ATestEnemyPlayer::OnMove(const struct FInputActionValue& inputValue)
{
