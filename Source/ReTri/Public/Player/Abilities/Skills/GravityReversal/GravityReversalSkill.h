...
#include "GravityReversalSkill.generated.h"

class AGravityReversalAoE;
 ...
 */
UCLASS()
class RETRI_API UGravityReversalSkill : public UAbilityBase
{
	GENERATED_BODY()

public:
	UGravityReversalSkill();
...
public:
	...
	TSubclassOf<AGravityReversalAoE> GravityReversalAoEClass;
